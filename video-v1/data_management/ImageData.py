...
class ImageData:
    ...
    def __init__(self, n_droplets: int, size: tuple,
                 ...
                 unit, images_added = 1):
        # unit: tuple (diameter_unit, volume_unit)
        ...
        # Accept tuple for units: (diameter_unit, volume_unit)
        if isinstance(unit, tuple):
            self.diameter_unit = unit[0]
            self.volume_unit = unit[1]
        else:
            self.diameter_unit = unit
            self.volume_unit = unit
        self.images_added = images_added

        self._diameter_distribution = ["Diameter", "", 0, 1, self.diameter_unit, False]
        self._volume_distribution = ["Volume", "", 0, 1, self.volume_unit, False]
    ...
    def __add__(self, other):
        ...
        return ImageData(new_n_droplets, self.size, 
                         ...
                         new_interval,
                         (self.diameter_unit, self.volume_unit), images_added)
