# Introduction
This repository implements machine learning to detect droplets on images. After the detection is performed, the dimentions of this images is calculated. The dimentions can be shown in real time with a connected webcam or to just a single image.
