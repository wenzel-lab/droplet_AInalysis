...
result_images_dir = path.join("datasets", "generated_droplets", "images")
result_labels_dir = path.join("datasets", "generated_droplets", "labels")
...
for background_path in backgrounds_paths:
    droplet_sample_size = randint(1,4)
    ...
    for j in range(i*21, i*21 + 21):
        place_images(
            ...
            output_image_path = path.join(result_images_dir, str(j) +".png"),
