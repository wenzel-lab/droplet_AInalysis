...
image_info_1 = get_dimentions(results, image_path_1, PIXEL_RATIO, UNIT, OMIT_BORDER_DROPLETS)
results = model.predict(image_path_2, imgsz = IMGSZ, conf=CONFIDENCE, max_det=MAX_DETECT)
image_info_2 = get_dimentions(results, image_path_1, PIXEL_RATIO, UNIT, OMIT_BORDER_DROPLETS)
new_info = image_info_1 + image_info_2
print(image_info_1)
show_graphics(image_info_1)
print(image_info_2)
show_graphics(image_info_2)
print(new_info)
show_graphics(new_info)
