...
class ImageData:
    ...
    def __add__(self, other):
        ...
        new_area_interval, chosen_instance = choose_interval(self.area_interval, other.area_interval[0], self.images_added, ImageData.batch_size, ImageData.max_batches)
